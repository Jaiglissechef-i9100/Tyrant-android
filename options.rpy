...
define config.name = _("The Tyrant S A Z Mod")

define gui.show_name = False

define config.version = "0.75P1and2SAZMod"
...
define config.save_directory = "TheTyrant-CustomV01"
...
init python:
    ...
    build.classify('game/images/**.mp4', 'images')
    ...
    build.classify('game/gui/**.mp4', 'images')
