    ...
    fixed:
        ...
        if dtime == 17:
            if setupnopron == False and setuppron == False and vdroom13lilsisbetlost == True:
                imagebutton auto "gui/icons/icon_talk_%s.png" xpos 1134 ypos 444 action (Hide ('mcroomicon1'), Jump('mcroom17nomessy')) hovered tt.Action ("Talk") focus_mask True
            if setupnopron == True and vdroom13lilsisbetlost == True or dtime == 17 and setuppron == True and vdroom13lilsisbetlost == True:
                imagebutton auto "gui/icons/icon_talk_%s.png" xpos 1134 ypos 444 action (Hide ('mcroomicon1'), Jump('mcroom17yesmessy')) hovered tt.Action ("Talk") focus_mask True
        ...
        if nicolereddress == 4:
            imagebutton auto "gui/icons/cloth_red_dress_%s.png" xpos 1200 ypos 360 action (Hide ('mcroomicon1'), Jump('nicolechangered')) hovered tt.Action ("[mother] should wear the Red Dress") focus_mask True
        if nicolebabydoll == 4:
            imagebutton auto "gui/icons/cloth_babydoll_%s.png" xpos 1300 ypos 360 action (Hide ('mcroomicon1'), Jump('nicolechangebaby')) hovered tt.Action ("[mother] should wear the Babydoll") focus_mask True
        if nicolesweaterpants == 4:
            imagebutton auto "gui/icons/cloth_sweater_pants_%s.png" xpos 1400 ypos 360 action (Hide ('mcroomicon1'), Jump('nicolechangesweater')) hovered tt.Action ("[mother] should wear the Sweater+Pants") focus_mask True
        if nicolerobe == 4:
            imagebutton auto "gui/icons/cloth_robe_%s.png" xpos 1500 ypos 360 action (Hide ('mcroomicon1'), Jump('nicolechangerobe')) hovered tt.Action ("[mother] should wear the Robe") focus_mask True
        imagebutton auto "gui/icons/cloth_leggins_%s.png" xpos 1600 ypos 360 action (Hide ('mcroomicon1'), Jump('nicolechangeleggins')) hovered tt.Action ("[mother] should wear the Top+Leggins") focus_mask True
